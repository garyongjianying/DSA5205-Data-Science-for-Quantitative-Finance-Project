...
#' 
## ----setstocks, echo=FALSE, warning=FALSE, error=FALSE-------------------------------------------
...
#' 
## ----setvars, echo=FALSE, warning=FALSE, error=FALSE---------------------------------------------
...
#' 
## ----getdata, echo=FALSE, warning=FALSE, error=FALSE---------------------------------------------
df_d <- data.frame()
df_m <- data.frame()
for (stock in stocks) {
...
#' 
#' \small
## ----fitdist, echo=FALSE, warning=FALSE, error=FALSE---------------------------------------------
# initialize vectors
...
#' 
## ----fitmvt, echo=FALSE, warning=FALSE, error=FALSE----------------------------------------------
...
## ----fitmvst, echo=FALSE, warning=FALSE, error=FALSE---------------------------------------------
...
## ----fitcopulas1, echo=FALSE, warning=FALSE, error=FALSE-----------------------------------------
# for (i in 1:10) {
...
## ----fitcopulas2, echo=FALSE, warning=FALSE, error=FALSE-----------------------------------------
...
## ----randomcopulas, echo=FALSE, warning=FALSE, error=FALSE---------------------------------------
...
#' ## Markowitz Model
#' 
## ----MPT, echo=FALSE, warning=FALSE, error=FALSE-------------------------------------------------
...
#' 
## ----getoutputs1, echo=FALSE,warning=FALSE-------------------------------------------------------
...
## ----showportfolios1, echo=FALSE,warning=FALSE, out.width="75%", fig.align = 'center', fig.show="hold"----
# print(g)

#' 
#' <!-- As an example, the tangency portfolio selected for the month beginning 2022-10-03 is shown above. -->
#' 
## ----showportfoliosa, echo=FALSE,warning=FALSE, out.width="75%", fig.align = 'center', fig.show="hold"----
# par(xpd=TRUE)
...
#' 
#' 
## ----getmorestats1, echo=FALSE,warning=FALSE-----------------------------------------------------
genAdditionalColumns <- function(table_out,start_value){
  col_change <- c(stocks,'RF','ER','ER_M','Sharpe', 'NextMonthReturns','Volatility','Ex-Post Sharpe')
...
#' 
## ----showreturns1, echo=FALSE,warning=FALSE, out.width="75%", fig.align = 'center'---------------
...
#' 
## ----comparelags1, echo=FALSE,warning=FALSE, out.width="75%", fig.align = 'center'---------------
...
#' 
## ----michaud, echo=FALSE,warning=FALSE-----------------------------------------------------------
...
## ----showportfolio2, echo=FALSE,warning=FALSE, out.width="75%", fig.align = 'center'-------------
# par(xpd=TRUE)
# barplot(t(ww[sort(c(seq(1,nrow(ww),10),ind)),]),col=rainbow(ncol(ww)), main='Selected Portfolio')
# legend("topright", legend = stocks,
#        fill = rainbow(ncol(ww)), ncol = 1,
...
#' 
## ----showreturns2, echo=FALSE,warning=FALSE, out.width="100%", fig.align = 'center'--------------
...
#' 
## ----comparelags2, echo=FALSE,warning=FALSE, out.width="75%", fig.align = 'center'---------------
nlags <- c(1,3,6,9,12,18,24)
returns <- c()
...
#' # Results
#' 
## ----finalallocation, echo=FALSE,warning=FALSE---------------------------------------------------
...
#' 
## ----valresults, echo=FALSE,warning=FALSE--------------------------------------------------------
